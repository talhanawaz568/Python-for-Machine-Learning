...
#echo "old_name1,old_name2,NumericColumn" > example_data.csv
echo " Alice ,New York,25" >> example_data.csv
echo "Bob,Los Angeles,30" >> example_data.csv
echo "Bob,Los Angeles,30" >> example_data.csv
echo ",Chicago," >> example_data.csv
echo "Charlie,,35" >> example_data.csv
